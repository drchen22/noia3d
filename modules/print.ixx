...
namespace _print_details {
    ...
    export template <class T0, class ...Ts>
...
export using _print_details::print;
export using _print_details::printnl;
export using _print_details::print_adaptor;
export using _print_details::is_printable;
// Usage:
//
